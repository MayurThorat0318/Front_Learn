...
export default function CssReference() {
  ...
  const filtered = cssConcepts.filter(concept =>
  ...
  return (
    <main className="container reference-page fade-in">
      ...
      <section className="ref-hero">
        <span className="ref-badge css-badge">🎨 CSS</span>
        <h1>CSS Concepts Reference</h1>
        <p>
          Every CSS concept explained briefly with a live interactive demo.
          Hover, click, and interact with the demos to see CSS in action.
        </p>
      </section>
      ...
      {filtered.length === 0 && (
        <div className="no-concepts-found">
          ...
          <p>No CSS concept matches "{searchQuery}". Try a different search.</p>
